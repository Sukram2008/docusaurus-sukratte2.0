...
export default [
  {
    path: '/docusaurus-sukratte2.0/__docusaurus/debug',
    component: ComponentCreator('/docusaurus-sukratte2.0/__docusaurus/debug', '96e'),
    exact: true
  },
  {
    path: '/docusaurus-sukratte2.0/__docusaurus/debug/config',
    component: ComponentCreator('/docusaurus-sukratte2.0/__docusaurus/debug/config', '81a'),
    exact: true
  },
  {
    path: '/docusaurus-sukratte2.0/__docusaurus/debug/content',
    component: ComponentCreator('/docusaurus-sukratte2.0/__docusaurus/debug/content', '718'),
    exact: true
  },
  {
    path: '/docusaurus-sukratte2.0/__docusaurus/debug/globalData',
    component: ComponentCreator('/docusaurus-sukratte2.0/__docusaurus/debug/globalData', '540'),
    exact: true
  },
  {
    path: '/docusaurus-sukratte2.0/__docusaurus/debug/metadata',
    component: ComponentCreator('/docusaurus-sukratte2.0/__docusaurus/debug/metadata', 'a6f'),
    exact: true
  },
  {
    path: '/docusaurus-sukratte2.0/__docusaurus/debug/registry',
    component: ComponentCreator('/docusaurus-sukratte2.0/__docusaurus/debug/registry', '256'),
    exact: true
  },
  {
    path: '/docusaurus-sukratte2.0/__docusaurus/debug/routes',
    component: ComponentCreator('/docusaurus-sukratte2.0/__docusaurus/debug/routes', '3d1'),
    exact: true
  },
  {
